...
import { saveOwnParticipantAction } from '../actions';
...
export function OwnParticipantForm({ branches }: { branches: Branch[] }) {
  const [state, formAction] = useActionState<ActionState, FormData>(saveOwnParticipantAction, {});
